    ...
    return (
        <div className="Rectangle157 bg-design-green rounded-3xl grid grid-cols-2 gap-10 p-10">
            ...
            <div className='flex flex-col justify-center'>
                ...
                <p className="IntroductoryText mt-10 text-neutral-100 text-lg font-light font-inter leading-relaxed">
                ...
                <p className='my-4 text-neutral-100 font-light text-lg'>Sign up to receive our latest updates.</p>

                <input placeholder='Name' className='mt-2 rounded-3xl bg-transparent border border-design-light-green px-4 h-12 w-full placeholder:text-design-light-green text-white text-sm'></input>
                ...
                <p className='mt-5 text-neutral-100 font-light text-lg'>
