  ...
  return (
    <main className="Rectangle198 min-h-screen bg-gradient-to-b from-[#a8dadc] via-design-light to-white pt-[120px]">
      <div className="container mx-auto mt-14">
        <section>
          <div className="flex flex-col-reverse sm:grid sm:grid-cols-[1fr_2fr] gap-6 pb-10">
            <Image
              ...
              //sizes="20vmax"
            />
            <div className="flex w-full h-full sm:p-8 sm:bg-design-light rounded-2xl">
          ...
          <div className="flex flex-col sm:grid sm:grid-cols-[2fr_1fr] gap-6 pb-10">
            <div className="flex w-full h-full sm:p-8 sm:bg-design-light rounded-2xl">
              <div className="m-auto">
                <h1 className="text-5xl text-design-green font-[Inter] font-semibold pb-8">
                  Our vision
        ...
        <section className="flex flex-col-reverse sm:flex-row items-center justify-center gap-8 my-20 p-12 bg-[#fee9d7] rounded-2xl">
          <Image
        ...
        <section className="flex flex-col items-center max-w-[790px] mx-auto mb-12">
          ...
          <div className="sm:grid sm:grid-cols-2 sm:h-[16.4rem] mb-12 bg-[#fee9d7] rounded-2xl">
            ...
            <div className="flex relative ml-12 h-64 sm:h-full">
              <svg
